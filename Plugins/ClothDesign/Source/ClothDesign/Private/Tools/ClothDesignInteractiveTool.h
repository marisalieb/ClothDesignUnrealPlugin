...
#include "ClothDesignInteractiveTool.generated.h"


/**
 * Builder for UClothDesignInteractiveTool
 */
UCLASS()
class CLOTHDESIGN_API UClothDesignInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UClothDesignInteractiveTool
 */
UCLASS(Transient)
class CLOTHDESIGN_API UClothDesignInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UClothDesignInteractiveToolProperties();
...
/**
 * UClothDesignInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class CLOTHDESIGN_API UClothDesignInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UClothDesignInteractiveToolProperties> Properties;
